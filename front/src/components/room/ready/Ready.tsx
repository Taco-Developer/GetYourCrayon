      ...
      return (
        <RoomBody>
          ...
          <MoreDiv>
            <PickMenu>
              <SetBtn
                className={choice === 1 ? 'h-full text-4xl' : ''}
                onClick={() => {
                  setChoice(1);
                }}
              >
              ...
              <SetBtn
                className={choice === 2 ? 'h-full text-4xl' : ''}
                onClick={() => {
                  setChoice(2);
                }}
              >
...
const SetBtn = tw.div`h-90 w-50 text-2xl rounded-t-2xl text-white flex items-center justify-center bg-main-green mx-1`;
