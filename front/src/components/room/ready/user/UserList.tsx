...
const UserDiv = tw.div`w-90 h-auto m-auto p-1 border-black border-2 rounded-l-full rounded-r-2xl flex items-center justify-between`;
...
const SoundIcon = tw.div`h-9 xl:h-9 w-9 xl:w-7`;
